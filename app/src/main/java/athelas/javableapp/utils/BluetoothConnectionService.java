...
public class BluetoothConnectionService {
    ...
    private class AcceptThread extends Thread {
        ...
        public void run(){
            ...
            try{
                // socket.accept() is a blocking call and will only return on a
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            try{
                ...
                // in the case that this device was not the one to iniate the connection, then the dialogbox
                // would never have popped up in the first place.
                e.printStackTrace();
            }
        ...
        public void run() {
            ...
            // Keep Listening to the InputStream until an exception occures
            while(true) {
                try {
                    ...
                    // Send the message to the TextView with an Intent
                    Intent msgIntent = new Intent("incomingMessage");
                    msgIntent.putExtra("data", incomingMessage);
        ...
        // Access point to send data to the remote device (from MainActivity)
